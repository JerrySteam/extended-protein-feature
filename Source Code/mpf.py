...
for dataset in dataset_ls:
    ...
    int_hp = pd.read_csv(intx_path, delimiter='\t', encoding='latin-1').iloc[:, 1:]
    nonint_hp = pd.read_csv(nonintx_path, delimiter='\t', encoding='latin-1').iloc[:, 1:]
